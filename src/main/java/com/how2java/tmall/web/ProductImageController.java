...
public class ProductImageController {
    ...
    public List<ProductImage> listSingleProductImages(@PathVariable("pid") int pid, @RequestParam("type") String type) throws Exception{
    ...
    public Object add(@RequestParam("pid") int pid, @RequestParam("type") String type, MultipartFile image, HttpServletRequest request) throws Exception {
        ...
        String fileName = file.getName();//含有文件后缀
