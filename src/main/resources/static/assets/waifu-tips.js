...
function showHitokoto(){
	...
	/*
	$.getJSON('101.37.172.245:8080/hitokoto/rand/?encode=jsc&uid=3335',function(result){
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'http://101.37.172.245:10226/live2d/get/?id='+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: 'http://101.37.172.245:10226/live2d/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
...
function loadOtherModel(){
    ...
    $.ajax({
        cache: false,
        url: 'http://101.37.172.245:10226/live2d/'+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
